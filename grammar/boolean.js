...
const lexer = moo.compile({
 ...
 const mooId = (d) => d[0].value; var grammar = {
    ...
    {"name": "BinaryRel", "symbols": [(lexer.has("_br0") ? {type: "_br0"} : _br0)], "postprocess": mooId},
    ...
    {"name": "ExpValue", "symbols": [(lexer.has("_t") ? {type: "_t"} : _t)], "postprocess": mooId},
    {"name": "ExpValue", "symbols": [(lexer.has("_f") ? {type: "_f"} : _f)], "postprocess": mooId},

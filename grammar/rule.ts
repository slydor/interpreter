...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "property$string$1", "symbols": [{"literal":"N"}, {"literal":"a"}, {"literal":"m"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "property", "symbols": ["property$string$1"], "postprocess": id},
    {"name": "property$string$2", "symbols": [{"literal":"N"}, {"literal":"r"}], "postprocess": (d) => d.join('')},
    {"name": "property", "symbols": ["property$string$2"], "postprocess": id},
    {"name": "property$string$3", "symbols": [{"literal":"S"}, {"literal":"t"}, {"literal":"a"}, {"literal":"t"}, {"literal":"u"}, {"literal":"s"}], "postprocess": (d) => d.join('')},
    {"name": "property", "symbols": ["property$string$3"], "postprocess": id},
    {"name": "property$string$4", "symbols": [{"literal":"R"}, {"literal":"e"}, {"literal":"a"}, {"literal":"d"}, {"literal":"y"}], "postprocess": (d) => d.join('')},
    {"name": "property", "symbols": ["property$string$4"], "postprocess": id},
    {"name": "relation$string$1", "symbols": [{"literal":"="}, {"literal":"="}], "postprocess": (d) => d.join('')},
    {"name": "relation", "symbols": ["relation$string$1"], "postprocess": id},
    {"name": "relation$string$2", "symbols": [{"literal":"!"}, {"literal":"="}], "postprocess": (d) => d.join('')},
    {"name": "relation", "symbols": ["relation$string$2"], "postprocess": id},
    {"name": "relation", "symbols": [{"literal":"<"}], "postprocess": id},
    {"name": "relation$string$3", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": (d) => d.join('')},
    {"name": "relation", "symbols": ["relation$string$3"], "postprocess": id},
    {"name": "relation", "symbols": [{"literal":">"}], "postprocess": id},
    {"name": "relation$string$4", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": (d) => d.join('')},
    {"name": "relation", "symbols": ["relation$string$4"], "postprocess": id},
    ...
    {"name": "boolean", "symbols": ["boolean$string$1"], "postprocess": (b) => true},
    {"name": "boolean$string$2", "symbols": [{"literal":"f"}, {"literal":"a"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "boolean", "symbols": ["boolean$string$2"], "postprocess": (b) => false}
];

export var ParserStart: string = "rule";
